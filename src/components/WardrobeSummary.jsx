...
import { Trash2, Shirt, Droplets, Layers, Pencil } from 'lucide-react'
            ...
            return (
              <li key={o.id} className="overflow-hidden rounded-2xl" style={{ background: 'white', border: '1px solid var(--color-mist-2)' }}>
                {isConfirming ? (
                  ...
                  /* Tapping anywhere on the row (except the trash button) opens the edit sheet */
                  <button
                    className="flex w-full items-center gap-3 p-2.5 text-left"
                    onClick={() => setEditingOutfit(o)}
                  ...
                  >
                    ...
                    <Pencil size={13} style={{ color: 'var(--color-ink-soft)', flexShrink: 0 }} />
                    <button
